...
const teamNames = [      {"tid": 159, "cid": 0, "did": 0, "school": "Boston College", "name": "Eagles", "abbrev": "BC", "pop": 161, "city": "Chestnut Hill", "state": "MA", "latitude": 42.330, "longitude": -71.166},
...
function Welcome(){
  return (<h1>With March Madness upon us, we want to create a website that lists out
information about all the colleges in NCAA Basketball.</h1>);
}

class Team extends React.Component <{school : string, name :string, state:string, city:string}>{
  render(){
    ...
    <div>
        ...
        <h2>Location:{oneTeam.state},  {oneTeam.city} </h2>
        <br/>
        </div>
